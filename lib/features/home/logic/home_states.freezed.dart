...
class __$$LoadedImplCopyWithImpl<T, $Res>
    extends _$HomeStatesCopyWithImpl<T, $Res, _$LoadedImpl<T>>
...
abstract class Loaded<T> implements HomeStates<T> {
  const factory Loaded() = _$LoadedImpl<T>;
}

/// @nodoc
abstract class _$$ToggleMethodImplCopyWith<T, $Res> {
  factory _$$ToggleMethodImplCopyWith(_$ToggleMethodImpl<T> value,
          $Res Function(_$ToggleMethodImpl<T>) then) =
      __$$ToggleMethodImplCopyWithImpl<T, $Res>;
}

/// @nodoc
class __$$ToggleMethodImplCopyWithImpl<T, $Res>
    extends _$HomeStatesCopyWithImpl<T, $Res, _$ToggleMethodImpl<T>>
    implements _$$ToggleMethodImplCopyWith<T, $Res> {
  __$$ToggleMethodImplCopyWithImpl(
      _$ToggleMethodImpl<T> _value, $Res Function(_$ToggleMethodImpl<T>) _then)
      : super(_value, _then);
...
class _$ToggleMethodImpl<T> implements ToggleMethod<T> {
  const _$ToggleMethodImpl();

  @override
  String toString() {
    return 'HomeStates<$T>.toggleMethod()';
  }

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType && other is _$ToggleMethodImpl<T>);
  }
...
abstract class ToggleMethod<T> implements HomeStates<T> {
  const factory ToggleMethod() = _$ToggleMethodImpl<T>;
}
...
class __$$EmptyImplCopyWithImpl<T, $Res>
    extends _$HomeStatesCopyWithImpl<T, $Res, _$EmptyImpl<T>>
...
abstract class Empty<T> implements HomeStates<T> {
